import bigimage from "../../assets/products/Chroma-Craft-Pack.png";
import smallImage from "../../assets/mobile/Canva-Templates.png";
...
const Card = ({ data, animationProps }) => {
  const { title, description, imageUrl, imageUrlsmall } = data;
