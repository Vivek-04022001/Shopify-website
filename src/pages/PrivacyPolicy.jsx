  ...
  return (
    <div className="relative">
      ...
      <div className="Container-other ">
        <h1 className="other-heading">Privacy Policy</h1>
        <div className="border-t px-6">
          ...
          <h2 className=" highlight font-bold underline">
            Interpretation and Definitions
          </h2>
          <h3 className=" highlight pl-4 font-bold">Interpretation</h3>
          <p>
          ...
          <h3 className=" highlight pl-4 font-bold">Definitions</h3>
          <p>For the purposes of this Privacy Policy:</p>
          <ol type="1" border-b dashed border-primary>
            <li>
              <p>
                <strong className="font-bold text-primary/70 text-white">
                  Account
                </strong>{" "}
          ...
          <h3 className=" highlight pl-4 font-bold">Types of Data Collected</h3>
          <h4 className="font-bold underline">Personal Data</h4>
          <p>
          ...
          <ol type="A" className=" dashed border-primary">
            <li>
              <p>Email address</p>
            </li>
            <li>
          ...
          <h4 className="font-bold underline">Usage Data</h4>
          ...
          <h3 className=" highlight pl-4 font-bold">
          ...
          <h4 className="font-bold underline">Business Transactions</h4>
          <p>
          ...
          <h4 className="font-bold underline">Law enforcement</h4>
          <p>
          ...
          <h4 className="font-bold underline">Other legal requirements</h4>
          <p>
          ...
          <h2 className=" highlight font-bold underline">Children's Privacy</h2>
          <p>
          ...
          <h2 className=" highlight font-bold underline">Contact Us</h2>
          <p>
            If you have any questions about this Privacy Policy, You can contact
            us:
          </p>
          <ol type="1" border-b dashed border-primary>
            <li>By email: support@pixelvista.in</li>
          </ol>
        </div>
      </div>
    </div>
